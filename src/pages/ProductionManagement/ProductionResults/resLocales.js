...
const RES_TEXT = {
  vi: {
    ...
    "Rework = NG pieces with the Rework disposition in NG Management.": "Sửa lại = số sản phẩm NG có phương án Sửa lại trong Quản lý NG.",
  ...
  ja: {
    ...
    "Rework = NG pieces with the Rework disposition in NG Management.": "品質NG管理で手直し処置されたNG数。",
