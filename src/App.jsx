    ...
    return (<Router>
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          ...
          <Route path="/production-management/planning" element={<ProductionPlanning />}/>
          <Route path="/production-management/production-orders/list" element={<ProductionOrderList />}/>
          <Route path="/production-management/production-orders/detail" element={<ProductionOrderDetail />}/>
          <Route path="/production-management/work-orders/management" element={<WorkOrderManagement />}/>
          <Route path="/production-management/work-orders/execution" element={<ProductionExecution />}/>
          <Route path="/production-management/results" element={<ProductionResults />}/>
          <Route path="/machine-equipment/machine-monitoring" element={<MachineMonitoring />}/>
          <Route path="/machine-equipment/machine-detail" element={<MachineDetail />}/>
          <Route path="/machine-equipment/equipment-monitoring" element={<EquipmentMonitoring />}/>
          <Route path="/machine-equipment/downtime-management" element={<DowntimeManagement />}/>
          <Route path="/machine-equipment/alarm-history" element={<AlarmHistory />}/>
          <Route path="/mold-management/overview" element={<MoldOverview />}/>
          ...
          <Route path="/mold-management/installation-history" element={<MoldInstallationHistory />}/>
          <Route path="/mold-management/shot-counter" element={<MoldShotCounter />}/>
          <Route path="/mold-management/location" element={<MoldLocation />}/>
          <Route path="/material-management/status" element={<MaterialStatus />}/>
          <Route path="/material-management/requirement" element={<MaterialRequirement />}/>
          <Route path="/material-management/allocation" element={<MaterialAllocation />}/>
          <Route path="/material-management/usage" element={<MaterialUsage />}/>
          <Route path="/material-management/lot-history" element={<MaterialLotHistory />}/>
          <Route path="/quality-management/dashboard" element={<QualityDashboard />}/>
          <Route path="/quality-management/inspection-management" element={<InspectionManagement />}/>
          <Route path="/quality-management/spc-monitoring" element={<SPCMonitoring />}/>
          <Route path="/quality-management/ng-management" element={<NGManagement />}/>
          <Route path="/quality-management/measuring-equipment" element={<MeasuringEquipment />}/>
          <Route path="/quality-management/calibration-management" element={<CalibrationManagement />}/>
          <Route path="/maintenance-management/overview" element={<MaintenanceOverview />}/>
          <Route path="/maintenance-management/requests" element={<MaintenanceRequests />}/>
          <Route path="/maintenance-management/planning" element={<MaintenancePlanning />}/>
          <Route path="/maintenance-management/machine-equipment-maintenance" element={<MachineEquipmentMaintenance />}/>
          <Route path="/maintenance-management/mold-maintenance" element={<MoldMaintenance />}/>
          <Route path="/maintenance-management/production-tool-maintenance" element={<ProductionToolMaintenance />}/>
          <Route path="/maintenance-management/history" element={<MaintenanceHistory />}/>
          <Route path="/traceability/product" element={<ProductTraceability />}/>
          <Route path="/traceability/material" element={<MaterialTraceability />}/>
          <Route path="/traceability/lot-genealogy" element={<LotGenealogy />}/>
          <Route path="/reports-analytics/report-center" element={<ReportCenter />}/>
          ...
          <Route path="/system-configuration/master-data/factory-structure" element={<FactoryStructureMaster />}/>
          <Route path="/system-configuration/master-data/product" element={<ProductMaster />}/>
          <Route path="/system-configuration/master-data/machine-equipment" element={<MachineEquipmentMaster />}/>
          <Route path="/system-configuration/master-data/mold" element={<MoldMaster />}/>
          <Route path="/system-configuration/master-data/material" element={<MaterialMaster />}/>
          <Route path="/system-configuration/master-data/production-tool" element={<ProductionToolMaster />}/>
          <Route path="/system-configuration/master-data/measuring-equipment" element={<MeasuringEquipmentMaster />}/>
          <Route path="/system-configuration/master-data/quality-standard" element={<QualityStandardMaster />}/>
          <Route path="/system-configuration/master-data/process-parameter-standard" element={<ProcessParameterStandard />}/>
          <Route path="/system-configuration/master-data/shift-calendar" element={<ShiftCalendarMaster />}/>
          <Route path="/system-configuration/master-data/reason-code" element={<ReasonCodeMaster />}/>
          <Route path="/system-configuration/iot/data-dictionary" element={<IoTDataDictionary />}/>
          <Route path="/system-configuration/iot/device-mapping" element={<DeviceMapping />}/>
