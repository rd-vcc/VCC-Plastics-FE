...
export const UI_TEXT = {
  vi: {
    ...
    "Inspection Frequency": "Tần suất kiểm tra", "Add Characteristic": "Thêm đặc tính", "No characteristics yet.": "Chưa có đặc tính nào.",
  ...
  ja: {
    ...
    "Inspection Frequency": "検査頻度", "Add Characteristic": "特性を追加", "No characteristics yet.": "特性がまだありません。",
