...
export default function Login() {
  ...
  return (
    <>
      <PageMeta
        title={`${t("login.title")} | VCC Plastics`}
          ...
          <div className="relative hidden overflow-hidden bg-gray-900 lg:flex lg:items-center lg:justify-center">
            ...
            <div className="relative z-10 max-w-xl px-14 text-center">
              <img
                ...
                alt="VCC Plastics"
                className="mx-auto mb-10 w-full max-w-[360px] object-contain"
              />
            ...
            <div className="w-full max-w-md">
              ...
              <div className="mb-9 lg:hidden">
                <img
                  ...
                  alt="VCC Plastics"
                  className="h-auto w-[230px] object-contain dark:hidden"
                />

                <img
                  src="/images/logo/logo-dark.png"
                  alt="VCC Plastics"
                  className="hidden h-auto w-[230px] object-contain dark:block"
                />
              </div>
              ...
              <div className="rounded-2xl border border-gray-200 bg-white p-7 shadow-theme-sm dark:border-gray-800 dark:bg-gray-900 sm:p-9">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute right-3 top-1/2 -translate-y-1/2 rounded-md p-1 text-gray-500 hover:text-gray-700 disabled:cursor-not-allowed disabled:opacity-50 dark:text-gray-400 dark:hover:text-gray-200"
                        aria-label={
                          showPassword
                      ...
                      >
                        {showPassword ? (
                          ...
                          >
                            ...
                            <path
                              d="M9.9 5.2A10.8 10.8 0 0112 5c5.1 0 8.5 4.4 9 7-.2 1.1-.9 2.5-2 3.7M6.4 6.4C4.5 7.8 3.3 10 3 12c.5 2.6 3.9 7 9 7 1.4 0 2.7-.3 3.8-.8"
                              stroke="currentColor"
                              strokeWidth="1.7"
                              strokeLinecap="round"
                  ...
                  {/* ERROR */}
                  {error && (
                    <div className="rounded-lg border border-error-200 bg-error-50 px-4 py-3 text-sm text-error-600 dark:border-error-900/50 dark:bg-error-500/10 dark:text-error-400">
                      {error}
                    </div>
                  )}
                  ...
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className="inline-flex h-11 w-full items-center justify-center rounded-lg bg-brand-500 px-5 text-sm font-medium text-white shadow-theme-xs transition hover:bg-brand-600 focus:outline-none focus:ring-3 focus:ring-brand-500/20 disabled:cursor-not-allowed disabled:opacity-70"
                  >
