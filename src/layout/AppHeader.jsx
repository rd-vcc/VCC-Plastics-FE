...
const AppHeader = () => {
    ...
    return (<header className="sticky top-0 z-99999 flex w-full border-gray-200 bg-gray-50 dark:border-gray-800 dark:bg-gray-950 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-3">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-1.5">
          <button className="items-center justify-center w-9 h-9 text-gray-500 border-gray-200 rounded-lg z-99999 dark:border-gray-800 lg:flex dark:text-gray-400 lg:h-9 lg:w-9 lg:border" onClick={handleToggle} aria-label={t("common.toggleSidebar")}>
          ...
          <button onClick={toggleApplicationMenu} className="flex items-center justify-center w-9 h-9 text-gray-700 rounded-lg z-99999 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 lg:hidden">
          ...
          <div className="hidden lg:block">
            <form>
              <div className="relative">
                ...
                <input ref={inputRef} type="text" placeholder={t("common.searchPlaceholder")} className="dark:bg-dark-900 h-9 w-full rounded-md border border-gray-200 bg-transparent py-2 pl-10 pr-12 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-800 dark:bg-gray-900 dark:bg-white/[0.03] dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800 xl:w-[430px]"/>
        ...
        <div className={`${isApplicationMenuOpen ? "flex" : "hidden"} items-center justify-between w-full gap-4 px-5 py-4 lg:flex shadow-theme-md lg:justify-end lg:px-0 lg:py-1.5 lg:shadow-none`}>
