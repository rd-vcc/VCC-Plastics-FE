...
export const UI_TEXT = {
  vi: {
    ...
    "Commissioning Date": "Ngày đưa vào sử dụng", "Image URL": "Đường dẫn hình ảnh", "Image": "Ảnh minh họa", "Asset Status": "Trạng thái tài sản", "Operational Status": "Trạng thái vận hành",
  ...
  ja: {
    ...
    "Commissioning Date": "稼働開始日", "Image URL": "画像URL", "Image": "画像", "Asset Status": "資産状態", "Operational Status": "運転状態", "Description": "説明",
